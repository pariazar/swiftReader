...
public class AboutActivity extends CyaneaAppCompatActivity {
    ...
    public void emailDev(View v) {
        startActivity(Utils.emailIntent("hamedpa21@gmail.com", "Swift Reader", APP_VERSION_RELEASE, "Send email..."));
    }

    public void navToGit(View v) {
        startActivity(Utils.linkIntent("https://github.com/hamedpa"));
    }

    public void navToSourceCode(View v) {
        startActivity(Utils.linkIntent("https://github.com/hamedpa/swiftReader"));
    }
    @Override
